...
open class VideoScrubber: UIControl {
    ...
    func setup() {
        ...
        timeLabel.attributedText = NSAttributedString(string: "--:--", attributes: [.foregroundColor: UIColor.white, .font: UIFont.systemFont(ofSize: 12)])
    ...
    @objc func updateCurrentTime() {
        ...
        if let duration = self.duration , self.duration != nil {
            ...
            timeLabel.attributedText = NSAttributedString(string: timeString, attributes: [.foregroundColor : tintColor, .font : UIFont.systemFont(ofSize: 12)])
        }
        else {
            timeLabel.attributedText = NSAttributedString(string: "--:--", attributes: [.foregroundColor: tintColor, .font: UIFont.systemFont(ofSize: 12)])
        }
    }
